...
# -*- coding: utf-8 -*-
#
# First Steps in Python documentation build configuration file, created by
...
# Flag when we are on readthedocs.org
...
texinfo_documents = [
    (master_doc, project, title,
     author, ''.join(title.split()),
     'Python for beginners with a STEM flavour.',
     'Miscellaneous'),
]
